...
function AddFatura(){
    ...
    const sendInfo = () =>{
      ...
      const GetData = async () => { 
        ...
        const configBody = {
            Tip: tip,Odendi:false,Miktar:miktar,UserId:id,DaireId:did,Ay:ay,Yıl:yıl
        };
        const result = await axios.post('http://localhost:5133/api/Fatura',configBody,configHeader); 
        console.log(result);
    ...
    return(
      ...
      <Row style={{width:'50%'}}>  
        <Col>  
          <Card>  
            <CardHeader>  
              <i className="fa fa-align-justify"></i> Fatura Ekle 
              </CardHeader>  
